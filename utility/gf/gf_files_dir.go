...
// TraverVueDir-vue前端遍历多个目录
//
//	DirOption : 遍历选项
//	tree : 遍历结果
func TraverVueDir(option DirOption, pathroot string) (Node, error) {
	// 根节点
	var root Node
...
//	node : 目录节点
//	option : 遍历选项
func explorerRecursive(node *Node, option *DirOption, pathroot string) {
