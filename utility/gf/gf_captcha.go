...
// 生成图片验证码
func GenerateCaptcha(ctx context.Context) (interface{}, error) {
	// 生成默认数字
	...
	captchaResult := CaptchaResult{Id: id, Show: gconv.Bool(loginCaptcha), Base64Blog: b64s, ExpireTime: time.Now().Add(Expiration).UnixMilli()}
