...
// OperationLogColumns defines and stores column names for the table gf_operation_log.
...
// operationLogColumns holds the columns for the table gf_operation_log.
