...
const (
	...
	// StackFilterKeyForSuxin is the stack filtering key for all Suxin module paths.
	// Eg: .../pkg/mod/github.com/suxinwl/GoSuxin/framework@v2.0.0-20211011134327-54dd11f51122/debug/gdebug/gdebug_caller.go
	StackFilterKeyForSuxin = "github.com/gogf/gf/"
)
