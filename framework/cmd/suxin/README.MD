...
```shell
go install github.com/suxinwl/GoSuxin/framework/cmd/suxin@latest # latest version
go install github.com/suxinwl/GoSuxin/framework/cmd/suxin@v2.5.5 # certain version(should be >= v2.5.5)
```
