...
const (
	CGenEnumsConfig = `suxincli.gen.enums`
	CGenEnumsBrief  = `parse go files in current project and generate enums go file`
	CGenEnumsEg     = `
suxin gen enums
suxin gen enums -p internal/packed/packed_enums.go
suxin gen enums -p internal/packed/packed_enums.go -s .
suxin gen enums -x github.com/gogf
`
)
