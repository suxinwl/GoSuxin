...
import (
	...
	"github.com/suxinwl/GoSuxin/framework/os/gstructs"
	"github.com/suxinwl/GoSuxin/framework/text/gstr"
)

type pkgItem struct {
	Alias     string `eg:"gdbas"`
	Path      string `eg:"github.com/suxinwl/GoSuxin/framework/database/gdb"`
	RawImport string `eg:"gdbas github.com/suxinwl/GoSuxin/framework/database/gdb"`
}
...
// If package is "github.com/suxinwl/GoSuxin/framework", the alias is "gf" instead of "v2".
