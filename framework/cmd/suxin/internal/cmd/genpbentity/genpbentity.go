...
import (
	...
	"github.com/suxinwl/GoSuxin/framework/container/gset"
	...
	"github.com/suxinwl/GoSuxin/framework/cmd/suxin/internal/consts"
...
const (
	...
	CGenPbEntityConfig   = `suxincli.gen.pbentity`
	CGenPbEntityBrief    = `generate entity message files in protobuf3 format`
	CGenPbEntityEg       = `
suxin gen pbentity
suxin gen pbentity -l "mysql:root:12345678@tcp(127.0.0.1:3306)/test"
suxin gen pbentity -p ./protocol/demos/entity -t user,user_detail,user_login
suxin gen pbentity -r user_ -k github.com/gogf/gf/example/protobuf
suxin gen pbentity -r user_
`
...
`
	...
	CGenPbEntityBriefLink              = `database configuration, the same as the ORM configuration of Suxin`
