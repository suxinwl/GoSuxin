...
func Test_Model_Builder(t *testing.T) {
	...
	// Where with do struct which has a field type of *gtime.Time and generated by suxin cli
	gtest.C(t, func(t *gtest.T) {
		m := db.Model(table)
		b := m.Builder()
	...
	// Where with do struct which has a field type of *gjson.Json and generated by suxin cli
	gtest.C(t, func(t *gtest.T) {
		m := db.Model(table)
		b := m.Builder()
