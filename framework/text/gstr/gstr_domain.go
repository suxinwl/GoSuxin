...
func IsSubDomain(subDomain string, mainDomain string) bool {
	...
	// Eg:
	// "www.suxinwl.com" is not sub-domain of "s.www.suxinwl.com".
	...
	// Eg:
	// "s.s.www.suxinwl.com" is not sub-domain of "*.www.suxinwl.com"
	// but
	// "s.s.www.suxinwl.com" is sub-domain of "www.suxinwl.com"
