...
func Test_CallerPackage(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		t.Assert(gdebug.CallerPackage(), "github.com/suxinwl/GoSuxin/framework/test/gtest")
	})
}
...
func Test_FuncPath(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		t.Assert(gdebug.FuncPath(Test_FuncPath), "github.com/suxinwl/GoSuxin/framework/debug/gdebug_test.Test_FuncPath")
	})
}
