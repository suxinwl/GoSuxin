...
const autoLoclecomponents = import.meta.glob('@/components/**/locale/zh-CN.ts', {
  eager: true,
});
//2.自动加载locale下对应语言目录
const autoLocle = import.meta.glob('@/locale/zh-CN/**.ts', {
  eager: true,
});
//3.自动加载views下的文件
const autoLocleviews = import.meta.glob('@/views/**/locale/zh-CN.ts', {
  eager: true,
});
